...
namespace Taoyuan_Traffic.Controllers.V1.PARK
{
    public class ParkingController : Controller
    {
        ...
        //動態公車用快取
        public async Task<IEnumerable<ParkingDeserialize>> GetBusDynamicData()
        {
            //setting cache
        ...
        public async Task<IEnumerable<ParkingDeserialize>> RetriveBusDynamicData(string cacheName)
        {
            //Setting target Url
            string targetURI = "http://data.tycg.gov.tw/api/v1/rest/datastore/0daad6e6-0632-44f5-bd25-5e1de1e9146f?format=json";
            HttpClient client = new HttpClient();
